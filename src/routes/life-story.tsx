  ...
  head: () => ({
    meta: [
      { title: "Life Story — Farhad Nouri" },
      {
        name: "description",
        content:
          "The journey of Farhad Nouri — from his first day on the mat to international competition.",
      },
    ],
  }),
  component: LifeStory,
...
const timeline = [
  ...
  {
    year: "2012",
    title: "National Youth Team",
    text: "Selected for the national youth squad after a breakout regional championship.",
    img: portrait,
  },
  {
    year: "2015",
    title: "First National Title",
    text: "Won my first senior national title in freestyle wrestling. A pivotal turning point.",
  },
  {
    year: "2018",
    title: "International Debut",
    text: "Stepped onto the international stage and brought home a continental medal.",
    img: action,
  },
  {
    year: "2020",
    title: "Crossover to Fitness",
    text: "Began competing in fitness and physique categories — a new discipline, same intensity.",
  },
  {
    year: "2023",
    title: "Coaching the Next Wave",
    text: "Opened doors to private coaching and clinics, sharing everything the mat taught me.",
    img: wrestlerSpotlight,
  },
  {
    year: "Today",
    title: "Building a Legacy",
    text: "Still competing. Still teaching. Still chasing the next level — every single day.",
  },
];
    ...
    <div>
      ...
      <section className="py-24 px-6">
        <div className="mx-auto max-w-3xl space-y-6 text-lg leading-relaxed text-muted-foreground">
          <p>
            I was born in a country where wrestling isn't just sport — it's heritage. The Pahlevan
            tradition teaches strength with humility, victory with honor. From my first practice as
            a child, I knew this was the path.
          </p>
          <p>
            What followed was years of early mornings, brutal training camps, weight cuts, podiums,
            and heartbreaks. Every loss became a lesson. Every win became fuel.
          </p>
        ...
        <div className="relative h-full max-w-6xl mx-auto px-6 flex items-center">
          <div className="max-w-lg">
            ...
            <p className="text-muted-foreground text-lg">
              Discipline is the bridge between dreams and results. I built mine one brick at a time
              — and I help others build theirs.
            </p>
          </div>
        </div>
      </section>
